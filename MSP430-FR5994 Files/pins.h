...
/* SPI Port Configuration for FR5994 (Primary Module Function on P5.0, P5.1, P5.2) */
#define SPI_CONFIG_PORT()                st( P5SEL1 &= ~(BV(SPI_SI_GPIO_BIT__) | BV(SPI_SO_GPIO_BIT__) | BV(SPI_SCLK_GPIO_BIT__)); \
                                             P5SEL0 |=  (BV(SPI_SI_GPIO_BIT__) | BV(SPI_SO_GPIO_BIT__) | BV(SPI_SCLK_GPIO_BIT__)); )
