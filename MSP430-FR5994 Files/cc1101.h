...
#include <stdint.h>
#include <msp430.h>
#include "macros.h" // Uncomment if these files exist natively in your CCS project
#include "pins.h"   // Uncomment if these files exist natively in your CCS project
